...
func GenerateCluster(name string, in v1beta1.ClusterParameters, cluster *container.Cluster) { // nolint:gocyclo
...
func GenerateObservation(in container.Cluster) v1beta1.ClusterObservation { // nolint:gocyclo
...
func LateInitializeSpec(spec *v1beta1.ClusterParameters, in container.Cluster) { // nolint:gocyclo
...
func IsUpToDate(name string, in *v1beta1.ClusterParameters, observed *container.Cluster) (bool, UpdateFn, error) { // nolint:gocyclo
